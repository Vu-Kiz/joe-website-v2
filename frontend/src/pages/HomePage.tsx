    ...
    <div className="app app--three faction-page">
          ...
          <div className={styles.views}>
            ...
            {showTerritories && (
              <>
                ...
                <h3>Tatoo</h3>
                <p className={styles.small}>Tatoo is the central hub of activity for the greater Jawa
                  ...
                  hosting a large, well-attended annual Swap Meet.</p>
                <h3>Geonosis</h3>
                <p className={styles.small}>The Geonosis system, home to the laborious Geonosian builders,
                  ...
                  allowed work permits in the system.</p>
                <h3>Pii</h3>
                <p className={styles.small}>The large coaxial asteroid rings and five volcanic planets of
                  ...
                  regulations.</p>
                <h3>Arvala</h3>
                <p className={styles.small}>Located in the Hunnovers sector, the Arvala system was
      ...
      <aside className="side-col">
        <section className="panel centered">
          ...
          <div className={styles.small}>
            <p>
              To join JOE, request diplomatic talks, or resolve contractual matters,
              please contact Grand Commodore Kolo Seph through official channels.
            </p>
          </div>
