...
return [
    ...
    'member_tools_scope' => env('SWC_OAUTH_MEMBER_TOOLS_SCOPE', 'character_read character_events character_credits faction_credits_read character_privileges'),
    'member_tool_scopes' => [
        'galaxy' => 'character_read character_events',
        'payments' => 'character_read character_credits faction_credits_read character_privileges',
    ],
